...
export { adaptProduct, fetchCategorias, fetchProductos, fetchMarcas, fetchFacturas, parseTotal, fmtCompact, fmtDate, facturaStatusStyle, FetchProductosOpts, ProductosResult, FacturasResult } from '../composables/useSyscom';
export { useAuthStore, actions } from '../stores/auth';
