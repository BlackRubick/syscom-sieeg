declare global {
  ...
  const crearCFDI: typeof import('../../server/utils/factura').crearCFDI
  ...
  const eliminarCliente: typeof import('../../server/utils/factura').eliminarCliente
  const eventHandler: typeof import('../../node_modules/h3').eventHandler
  const facturaFetch: typeof import('../../server/utils/factura').facturaFetch
  ...
  const getFacturaHost: typeof import('../../server/utils/factura').getFacturaHost
  ...
  const getSyscomToken: typeof import('../../server/utils/syscom').getSyscomToken
  ...
  const listarCFDIs: typeof import('../../server/utils/factura').listarCFDIs
  ...
  const verifyToken: typeof import('../../server/utils/session').verifyToken
...
declare global {
  ...
  // @ts-ignore
  export type { SyscomCarritoOpts, SyscomCarritoResult } from '../../server/utils/syscom'
  import('../../server/utils/syscom')
}
