...
import { defineComponent, computed, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext, ref, watch, isRef } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from "vue/server-renderer";
...
import { _ as _sfc_main$3 } from "./FiscalDataModal-D-vEbvgR.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isMobile)) {
        _push(`<button style="${ssrRenderStyle({ "width": "30px", "height": "30px", "border-radius": "8px", "background": "rgba(255,255,255,0.06)", "border": "1px solid rgba(255,255,255,0.08)", "display": "flex", "align-items": "center", "justify-content": "center", "cursor": "pointer", "flex-shrink": "0", "margin-left": "auto" })}"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(148,163,184,0.8)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><nav style="${ssrRenderStyle({ "flex": "1", "padding": "8px 6px", "overflow-y": "auto", "overflow-x": "hidden" })}" class="no-scrollbar">`);
      if (!unref(collapsed) || unref(isMobile)) {
        _push(`<div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "600", "color": "rgba(71,85,105,0.8)", "text-transform": "uppercase", "letter-spacing": "1.2px", "padding": "4px 10px 8px", "user-select": "none" })}"> Navegación </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ...
      _push(`<!--]--></nav>`);
      if (!unref(isMobile)) {
        _push(`<button style="${ssrRenderStyle({ "position": "absolute", "right": "-11px", "top": "72px", "width": "22px", "height": "22px", "border-radius": "50%", "background": "#0D1B35", "border": "1px solid rgba(255,255,255,0.12)", "display": "flex", "align-items": "center", "justify-content": "center", "cursor": "pointer", "z-index": "30", "box-shadow": "0 2px 8px rgba(0,0,0,0.4)", "padding": "0" })}"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="rgba(148,163,184,0.8)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">`);
        if (!unref(collapsed)) {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function notifColor(type) {
      return notifColors[type] ?? "#94a3b8";
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({
        style: { height: "60px", display: "flex", alignItems: "center", padding: unref(isMobile) ? "0 16px" : "0 24px", borderBottom: "1px solid rgba(255,255,255,0.06)", background: "rgba(8,16,32,0.9)", backdropFilter: "blur(12px)", flexShrink: 0, gap: "12px", position: "sticky", top: 0, zIndex: 10, fontFamily: `'Inter',system-ui,sans-serif` }
      }, _attrs))}>`);
      if (unref(isMobile)) {
        _push(`<button style="${ssrRenderStyle({ "width": "36px", "height": "36px", "border-radius": "10px", "background": "transparent", "border": "1px solid transparent", "display": "flex", "align-items": "center", "justify-content": "center", "cursor": "pointer", "flex-shrink": "0" })}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(148,163,184,0.9)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</button>`);
      if (unref(notifOpen)) {
        _push(`<div style="${ssrRenderStyle({ position: "absolute", right: 0, top: "44px", width: unref(isMobile) ? "calc(100vw - 32px)" : "300px", maxWidth: "300px", background: "#0D1B35", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "14px", boxShadow: "0 16px 48px rgba(0,0,0,0.6)", overflow: "hidden", zIndex: 50 })}"><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "align-items": "center", "padding": "12px 14px", "border-bottom": "1px solid rgba(255,255,255,0.07)" })}"><span style="${ssrRenderStyle({ "font-size": "13px", "font-weight": "600", "color": "#E2E8F0" })}">Notificaciones</span>`);
        if (unref(ui).unreadCount > 0) {
          _push(`<button style="${ssrRenderStyle({ "font-size": "11px", "color": "#38bdf8", "background": "none", "border": "none", "cursor": "pointer", "font-weight": "500" })}">Marcar leídas</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div style="${ssrRenderStyle({ "max-height": "280px", "overflow-y": "auto" })}"><!--[-->`);
        ssrRenderList(unref(ui).notifications, (n) => {
          _push(`<div style="${ssrRenderStyle({ display: "flex", gap: "10px", padding: "11px 14px", borderBottom: "1px solid rgba(255,255,255,0.04)", cursor: "pointer", background: !n.read ? "rgba(14,165,233,0.04)" : "transparent" })}"><div style="${ssrRenderStyle({ width: "30px", height: "30px", borderRadius: "8px", background: `${notifColor(n.type)}18`, border: `1px solid ${notifColor(n.type)}30`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: notifColor(n.type) })}"><svg width="14" height="14" viewBox="0 0 24 24" fill="none"${ssrRenderAttr("stroke", notifColor(n.type))} stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${notifIcon(n.type) ?? ""}</svg></div><div style="${ssrRenderStyle({ "flex": "1", "min-width": "0" })}"><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#CBD5E1" })}">${ssrInterpolate(n.title)}</div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.8)", "margin-top": "2px", "overflow": "hidden", "display": "-webkit-box", "-webkit-line-clamp": "2", "-webkit-box-orient": "vertical" })}">${ssrInterpolate(n.message)}</div></div>`);
          if (!n.read) {
      ...
      if (!unref(isMobile)) {
        _push(`<div style="${ssrRenderStyle({ "text-align": "left" })}"><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#E2E8F0", "line-height": "1" })}">${ssrInterpolate(unref(firstName))}</div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "rgba(100,116,139,0.8)", "margin-top": "2px" })}">${ssrInterpolate(unref(roleLabel))}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(isMobile)) {
        _push(`<svg${ssrRenderAttr("width", 12)}${ssrRenderAttr("height", 12)} viewBox="0 0 24 24" fill="none" stroke="rgba(100,116,139,0.7)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="${ssrRenderStyle({ transition: "transform 0.2s", transform: unref(userOpen) ? "rotate(180deg)" : "rotate(0deg)", marginLeft: "2px" })}"><path d="m6 9 6 6 6-6"></path></svg>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button>`);
      if (unref(userOpen)) {
        _push(`<div style="${ssrRenderStyle({ "position": "absolute", "right": "0", "top": "44px", "width": "200px", "background": "#0D1B35", "border": "1px solid rgba(255,255,255,0.1)", "border-radius": "14px", "box-shadow": "0 16px 48px rgba(0,0,0,0.6)", "overflow": "hidden", "z-index": "50" })}"><div style="${ssrRenderStyle({ "padding": "12px 14px", "border-bottom": "1px solid rgba(255,255,255,0.07)" })}"><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#E2E8F0" })}">${ssrInterpolate(unref(auth).user?.name)}</div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.8)", "margin-top": "2px" })}">${ssrInterpolate(unref(auth).user?.email)}</div></div><div style="${ssrRenderStyle({ "border-top": "1px solid rgba(255,255,255,0.07)" })}"><button style="${ssrRenderStyle({ "width": "100%", "display": "flex", "align-items": "center", "gap": "8px", "padding": "10px 14px", "font-size": "12px", "color": "#fb7185", "background": "none", "border": "none", "cursor": "pointer", "text-align": "left", "font-family": "inherit" })}"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" x2="9" y1="12" y2="12"></line></svg> Cerrar sesión </button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
//# sourceMappingURL=default-CRKbKPNz.js.map
