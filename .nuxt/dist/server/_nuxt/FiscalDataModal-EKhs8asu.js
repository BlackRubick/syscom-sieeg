import { _ as _sfc_main$1 } from "./FormField-CqV_UbYV.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.modelValue) {
          ...
          _push2(`</div><div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "700", "color": "#F1F5F9" })}">Datos fiscales</div><div style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.8)", "margin-top": "2px" })}">Necesarios para la emisión de facturas (CFDI)</div></div></div>`);
          if (!__props.required) {
          ...
          _push2(`<p style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.6)", "margin": "4px 0 0" })}">Escríbelo exactamente como aparece en tu constancia de situación fiscal.</p></div><div style="${ssrRenderStyle({ "grid-column": "1/-1" })}">`);
          _push2(ssrRenderComponent(_component_FormField, {
          ...
          _push2(`<p style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.6)", "margin": "4px 0 0" })}">Sin S.A. de C.V., S. de R.L., etc. Solo la razón social base.</p></div>`);
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Código Postal",
          ...
          _push2(`<div><label style="${ssrRenderStyle({ "display": "block", "font-size": "11px", "font-weight": "500", "color": "rgba(148,163,184,0.85)", "margin-bottom": "6px" })}"> Régimen Fiscal <span style="${ssrRenderStyle({ "color": "#fb7185" })}">*</span></label><select style="${ssrRenderStyle(selectStyle(unref(regimenFocus)))}"><option value="" style="${ssrRenderStyle({ "background": "#0D1B35" })}" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).regimen) ? ssrLooseContain(unref(form).regimen, "") : ssrLooseEqual(unref(form).regimen, "")) ? " selected" : ""}>Selecciona...</option><!--[-->`);
          ...
          _push2(`<!--]--></select></div><div><label style="${ssrRenderStyle({ "display": "block", "font-size": "11px", "font-weight": "500", "color": "rgba(148,163,184,0.85)", "margin-bottom": "6px" })}"> País <span style="${ssrRenderStyle({ "color": "#fb7185" })}">*</span></label><select style="${ssrRenderStyle(selectStyle(unref(paisFocus)))}"><option value="" style="${ssrRenderStyle({ "background": "#0D1B35" })}" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).pais) ? ssrLooseContain(unref(form).pais, "") : ssrLooseEqual(unref(form).pais, "")) ? " selected" : ""}>Selecciona...</option><!--[-->`);
          ...
          _push2(`</div></div><div style="${ssrRenderStyle(unref(activeTab) === "contact" ? null : { display: "none" })}"><p style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.75)", "margin": "0 0 16px" })}">Información adicional del contacto fiscal.</p><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "14px" })}">`);
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Nombre",
...
//# sourceMappingURL=FiscalDataModal-EKhs8asu.js.map
