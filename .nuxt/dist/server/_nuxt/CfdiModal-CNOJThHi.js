      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.open) {
          ...
          if (unref(result)) {
            ...
            _push2(` Agregar concepto </button></div><div style="${ssrRenderStyle({ "margin-bottom": "20px" })}" data-v-62eba563><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "700", "color": "rgba(100,116,139,0.5)", "text-transform": "uppercase", "letter-spacing": "1px", "margin-bottom": "10px" })}" data-v-62eba563>Configuración</div><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr 1fr", "gap": "12px", "margin-bottom": "12px" })}" data-v-62eba563><div data-v-62eba563><label style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,116,139,0.6)", "text-transform": "uppercase", "letter-spacing": "0.7px", "display": "block", "margin-bottom": "6px" })}" data-v-62eba563>Forma de pago</label><select${ssrRenderAttrs(selectStyle)} data-v-62eba563><option value="" data-v-62eba563${ssrIncludeBooleanAttr(Array.isArray(unref(formaPago)) ? ssrLooseContain(unref(formaPago), "") : ssrLooseEqual(unref(formaPago), "")) ? " selected" : ""}>Seleccionar...</option><!--[-->`);
...
//# sourceMappingURL=CfdiModal-CNOJThHi.js.map
