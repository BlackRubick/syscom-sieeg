    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(status) === "loading") {
        ...
        if (unref(authorization)) {
          _push(`<div style="${ssrRenderStyle({ "font-size": "11px", "font-family": "monospace", "color": "rgba(100,118,142,0.45)", "margin-bottom": "22px" })}">Autorización: ${ssrInterpolate(unref(authorization))}</div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        _push(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "align-items": "center", "text-align": "center", "gap": "4px" })}"><div style="${ssrRenderStyle({ "font-size": "18px", "font-weight": "700", "color": "#E2EAF4", "margin-bottom": "6px" })}">No se encontró información del pago</div><div style="${ssrRenderStyle({ "font-size": "13px", "color": "rgba(100,118,142,0.65)", "margin-bottom": "22px" })}">Si realizaste un pago, revisa el estado de tu orden.</div><a href="/orders" style="${ssrRenderStyle({ "height": "42px", "padding": "0 24px", "border-radius": "11px", "background": "linear-gradient(135deg,#0EA5E9,#0284C7)", "color": "white", "font-size": "13px", "font-weight": "600", "text-decoration": "none", "display": "inline-flex", "align-items": "center" })}"> Ver mis órdenes </a></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=return-adEkIlTt.js.map
