import { _ as _sfc_main$1 } from "./FormField-q4VHXPBn.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.modelValue) {
          ...
          _push2(`</div><div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "700", "color": "#E2EAF4" })}">Datos fiscales</div><div style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,118,142,0.8)", "margin-top": "2px" })}">Necesarios para la emisión de facturas (CFDI)</div></div></div>`);
          if (!__props.required) {
            _push2(`<button style="${ssrRenderStyle({ "width": "30px", "height": "30px", "border-radius": "8px", "background": "rgba(255,255,255,0.05)", "border": "1px solid rgba(255,255,255,0.1)", "display": "flex", "align-items": "center", "justify-content": "center", "cursor": "pointer", "color": "rgba(100,118,142,0.8)", "flex-shrink": "0" })}">`);
          ...
          _push2(`<p style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,118,142,0.6)", "margin": "4px 0 0" })}">Escríbelo exactamente como aparece en tu constancia de situación fiscal.</p></div><div style="${ssrRenderStyle({ "grid-column": "1/-1" })}">`);
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Razón Social (sin régimen capital)",
          ...
          _push2(`<p style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,118,142,0.6)", "margin": "4px 0 0" })}">Sin S.A. de C.V., S. de R.L., etc. Solo la razón social base.</p></div>`);
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Código Postal",
          ...
          _push2(`<div><label style="${ssrRenderStyle({ "display": "block", "font-size": "11px", "font-weight": "500", "color": "rgba(123,146,176,0.85)", "margin-bottom": "6px" })}"> Régimen Fiscal <span style="${ssrRenderStyle({ "color": "#EF4444" })}">*</span></label><select style="${ssrRenderStyle(selectStyle(unref(regimenFocus)))}"><option value="" style="${ssrRenderStyle({ "background": "#0C1A2E" })}" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).regimen) ? ssrLooseContain(unref(form).regimen, "") : ssrLooseEqual(unref(form).regimen, "")) ? " selected" : ""}>Selecciona...</option><!--[-->`);
          ssrRenderList(REGIMENES, (r) => {
            _push2(`<option${ssrRenderAttr("value", r.clave)} style="${ssrRenderStyle({ "background": "#0C1A2E" })}"${ssrIncludeBooleanAttr(Array.isArray(unref(form).regimen) ? ssrLooseContain(unref(form).regimen, r.clave) : ssrLooseEqual(unref(form).regimen, r.clave)) ? " selected" : ""}>${ssrInterpolate(r.clave)} – ${ssrInterpolate(r.nombre)}</option>`);
          });
          _push2(`<!--]--></select></div><div><label style="${ssrRenderStyle({ "display": "block", "font-size": "11px", "font-weight": "500", "color": "rgba(123,146,176,0.85)", "margin-bottom": "6px" })}"> País <span style="${ssrRenderStyle({ "color": "#EF4444" })}">*</span></label><select style="${ssrRenderStyle(selectStyle(unref(paisFocus)))}"><option value="" style="${ssrRenderStyle({ "background": "#0C1A2E" })}" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).pais) ? ssrLooseContain(unref(form).pais, "") : ssrLooseEqual(unref(form).pais, "")) ? " selected" : ""}>Selecciona...</option><!--[-->`);
          ssrRenderList(PAISES, (p) => {
            _push2(`<option${ssrRenderAttr("value", p.clave)} style="${ssrRenderStyle({ "background": "#0C1A2E" })}"${ssrIncludeBooleanAttr(Array.isArray(unref(form).pais) ? ssrLooseContain(unref(form).pais, p.clave) : ssrLooseEqual(unref(form).pais, p.clave)) ? " selected" : ""}>${ssrInterpolate(p.clave)} – ${ssrInterpolate(p.nombre)}</option>`);
          });
          _push2(`<!--]--></select></div><div><label style="${ssrRenderStyle({ "display": "block", "font-size": "11px", "font-weight": "500", "color": "rgba(123,146,176,0.85)", "margin-bottom": "6px" })}">Uso de CFDI</label><select style="${ssrRenderStyle(selectStyle(unref(cfdiF)))}"><option value="" style="${ssrRenderStyle({ "background": "#0C1A2E" })}"${ssrIncludeBooleanAttr(Array.isArray(unref(form).usocfdi) ? ssrLooseContain(unref(form).usocfdi, "") : ssrLooseEqual(unref(form).usocfdi, "")) ? " selected" : ""}>Sin especificar</option><!--[-->`);
          ssrRenderList(USOS_CFDI, (c) => {
            _push2(`<option${ssrRenderAttr("value", c.clave)} style="${ssrRenderStyle({ "background": "#0C1A2E" })}"${ssrIncludeBooleanAttr(Array.isArray(unref(form).usocfdi) ? ssrLooseContain(unref(form).usocfdi, c.clave) : ssrLooseEqual(unref(form).usocfdi, c.clave)) ? " selected" : ""}>${ssrInterpolate(c.clave)} – ${ssrInterpolate(c.nombre)}</option>`);
          });
          _push2(`<!--]--></select></div></div></div><div style="${ssrRenderStyle(unref(activeTab) === "address" ? null : { display: "none" })}"><p style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,118,142,0.75)", "margin": "0 0 16px" })}">Domicilio fiscal tal como aparece en tu constancia de situación fiscal.</p><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "14px" })}"><div style="${ssrRenderStyle({ "grid-column": "1/-1" })}">`);
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Calle",
          ...
          _push2(`</div></div><div style="${ssrRenderStyle(unref(activeTab) === "contact" ? null : { display: "none" })}"><p style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,118,142,0.75)", "margin": "0 0 16px" })}">Información adicional del contacto fiscal.</p><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "14px" })}">`);
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Nombre",
          ...
          _push2(ssrRenderComponent(_component_FormField, {
            label: "Núm. Registro ID Tributario (extranjeros)",
            modelValue: unref(form).numregidtrib,
            "onUpdate:modelValue": ($event) => unref(form).numregidtrib = $event,
            placeholder: "SOLO SI APLICA",
            uppercase: ""
          }, null, _parent));
          _push2(`<p style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,118,142,0.6)", "margin": "4px 0 0" })}">Solo requerido para residentes en el extranjero.</p></div></div></div></div><div style="${ssrRenderStyle({ "padding": "16px 28px 24px", "flex-shrink": "0", "border-top": "1px solid rgba(255,255,255,0.06)" })}">`);
          if (unref(formError)) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "9px 12px", "border-radius": "8px", "background": "rgba(239,68,68,0.1)", "border": "1px solid rgba(239,68,68,0.25)", "font-size": "12px", "color": "#EF4444", "margin-bottom": "12px" })}">${ssrInterpolate(unref(formError))}</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "space-between", "gap": "10px" })}"><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,118,142,0.6)" })}">`);
          if (__props.required) {
...
//# sourceMappingURL=FiscalDataModal-GSDye5iO.js.map
