    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(modal)) {
          ...
          _push2(`<div style="${ssrRenderStyle({ "grid-column": "1/-1" })}"><div style="${ssrRenderStyle({ "font-size": "11px", "font-weight": "600", "color": "rgba(100,116,139,0.9)", "margin-bottom": "6px", "letter-spacing": "0.3px" })}">Descuento en catálogo (%)</div><div style="${ssrRenderStyle({ "position": "relative" })}"><input${ssrRenderAttr("value", unref(form).discountPct)} type="number" min="0" max="100" step="0.5" placeholder="0" style="${ssrRenderStyle({ "width": "100%", "height": "40px", "background": "rgba(255,255,255,0.04)", "border": "1px solid rgba(255,255,255,0.1)", "border-radius": "10px", "padding": "0 40px 0 14px", "font-size": "13px", "color": "#E2E8F0", "outline": "none", "font-family": "inherit", "box-sizing": "border-box", "transition": "border-color 0.2s" })}"><span style="${ssrRenderStyle({ "position": "absolute", "right": "13px", "top": "50%", "transform": "translateY(-50%)", "font-size": "13px", "color": "rgba(100,116,139,0.6)", "pointer-events": "none" })}">%</span></div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.5)", "margin-top": "5px" })}">0 = precio normal · 10 = 10% de descuento sobre precios SYSCOM</div></div></div>`);
          if (unref(formError)) {
...
//# sourceMappingURL=users-Ks2wHeue.js.map
