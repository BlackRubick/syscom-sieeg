import { _ as __nuxt_component_0 } from "./nuxt-link-BuVqOM4V.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(filtered), (order) => {
          ...
          if (unref(isManager) && order.userName) {
            _push(`<!--[--><span style="${ssrRenderStyle({ "color": "rgba(71,85,105,0.5)", "font-size": "11px" })}" data-v-57d520cc>·</span>`);
      ...
      if (!unref(loading) && !unref(error) && !unref(filtered).length) {
        ...
        _push(`<div style="${ssrRenderStyle({ "font-size": "14px", "font-weight": "600", "color": "#94a3b8" })}" data-v-57d520cc>Sin órdenes</div><div style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.7)" })}" data-v-57d520cc>${ssrInterpolate(unref(activeTab) === "all" ? "Aún no tienes órdenes" : "No hay órdenes con este estado")}</div>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(detail)) {
          ...
          if (unref(isManager) && unref(detail).userName) {
            _push2(`<!--[--><span style="${ssrRenderStyle({ "color": "rgba(71,85,105,0.5)" })}" data-v-57d520cc>·</span>`);
          ...
          _push2(`<span style="${ssrRenderStyle({ "font-size": "11px", "font-weight": "700", "color": "rgba(100,116,139,0.7)", "text-transform": "uppercase", "letter-spacing": "0.8px" })}" data-v-57d520cc>Productos · ${ssrInterpolate(unref(detail).items.length)}</span></div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column" })}" data-v-57d520cc><!--[-->`);
...
//# sourceMappingURL=orders-CBsdMqRV.js.map
