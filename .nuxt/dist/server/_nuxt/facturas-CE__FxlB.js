    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(tab) === "orders") {
        ...
        if (unref(loadingCfdis)) {
          ...
          _push(`<span data-v-06494b75>Serie S · ${ssrInterpolate(unref(cfdis).length)} CFDI${ssrInterpolate(unref(cfdis).length !== 1 ? "s" : "")} emitido${ssrInterpolate(unref(cfdis).length !== 1 ? "s" : "")} `);
          if (unref(totalFacturado) > 0) {
            _push(`<!--[--> · <span style="${ssrRenderStyle({ "color": "#a5b4fc" })}" data-v-06494b75>${ssrInterpolate(fmtMXN(unref(totalFacturado)))}</span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span>`);
...
//# sourceMappingURL=facturas-CE__FxlB.js.map
