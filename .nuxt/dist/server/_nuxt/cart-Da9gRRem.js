...
import { _ as _sfc_main$1 } from "./ProductModal-DV7syrtH.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(submitted)) {
        ...
        _push(`</div><div style="${ssrRenderStyle({ "font-size": "19px", "font-weight": "700", "color": "#E2E8F0", "margin-bottom": "7px" })}">Tu carrito está vacío</div><div style="${ssrRenderStyle({ "font-size": "13px", "color": "rgba(100,116,139,0.8)", "margin-bottom": "26px" })}">Agrega productos desde el catálogo</div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/catalog",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(` Agregar más productos `);
            } else {
              return [
                createVNode(unref(Plus), { size: 12 }),
                createTextVNode(" Agregar más productos ")
              ];
            }
          }),
          _: 1
        ...
        ssrRenderList(["🔒 Seguro", "⚡ < 24h", "✓ Trazable"], (badge) => {
...
//# sourceMappingURL=cart-Da9gRRem.js.map
