    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(status) === "loading") {
        ...
        if (unref(authorization)) {
          _push(`<div style="${ssrRenderStyle({ "font-size": "11px", "font-family": "monospace", "color": "rgba(100,116,139,0.45)", "margin-bottom": "22px" })}">Autorización: ${ssrInterpolate(unref(authorization))}</div>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=return-BGL7NeX_.js.map
