...
import { _ as _sfc_main$3 } from "./FiscalDataModal-GSDye5iO.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(collapsed) || unref(isMobile)) {
        _push(`<div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "600", "color": "rgba(100,118,142,0.8)", "text-transform": "uppercase", "letter-spacing": "1.2px", "padding": "4px 10px 8px", "user-select": "none" })}"> Navegación </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
...
//# sourceMappingURL=default-CiLg_ijk.js.map
