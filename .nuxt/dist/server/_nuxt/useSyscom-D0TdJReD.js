...
async function fetchProductos(opts) {
  ...
  params.set("por_pagina", String(opts.porPagina ?? 50));
  ...
  try {
    ...
    return empty(e instanceof Error ? e.message : "Error de conexión");
  }
}
...
export {
  adaptProduct as a,
  facturaStatusStyle as b,
  fmtCompact as c,
  fmtDate as d,
  fetchProductos as f,
  parseTotal as p
};
//# sourceMappingURL=useSyscom-D0TdJReD.js.map
