      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.open) {
          ...
          if (unref(result)) {
            ...
            _push2(`<!--]--></select></div><div data-v-61f411ea><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,116,139,0.6)", "margin-bottom": "5px" })}" data-v-61f411ea>Moneda</div><select${ssrRenderAttrs(sel)} data-v-61f411ea><option value="MXN" data-v-61f411ea${ssrIncludeBooleanAttr(Array.isArray(unref(form).moneda) ? ssrLooseContain(unref(form).moneda, "MXN") : ssrLooseEqual(unref(form).moneda, "MXN")) ? " selected" : ""}>MXN – Peso mexicano</option><option value="USD" data-v-61f411ea${ssrIncludeBooleanAttr(Array.isArray(unref(form).moneda) ? ssrLooseContain(unref(form).moneda, "USD") : ssrLooseEqual(unref(form).moneda, "USD")) ? " selected" : ""}>USD – Dólar</option></select></div><div data-v-61f411ea><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,116,139,0.6)", "margin-bottom": "5px" })}" data-v-61f411ea>Forma de pago *</div><select${ssrRenderAttrs(sel)} data-v-61f411ea><option value="" data-v-61f411ea${ssrIncludeBooleanAttr(Array.isArray(unref(form).formaPago) ? ssrLooseContain(unref(form).formaPago, "") : ssrLooseEqual(unref(form).formaPago, "")) ? " selected" : ""}>Seleccionar…</option><!--[-->`);
            ...
            _push2(`<!--]--></select></div><div data-v-61f411ea><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,116,139,0.6)", "margin-bottom": "5px" })}" data-v-61f411ea>Método de pago *</div><select${ssrRenderAttrs(sel)} data-v-61f411ea><option value="PUE" data-v-61f411ea${ssrIncludeBooleanAttr(Array.isArray(unref(form).metodoPago) ? ssrLooseContain(unref(form).metodoPago, "PUE") : ssrLooseEqual(unref(form).metodoPago, "PUE")) ? " selected" : ""}>PUE – Una sola exhibición</option><option value="PPD" data-v-61f411ea${ssrIncludeBooleanAttr(Array.isArray(unref(form).metodoPago) ? ssrLooseContain(unref(form).metodoPago, "PPD") : ssrLooseEqual(unref(form).metodoPago, "PPD")) ? " selected" : ""}>PPD – Parcialidades o diferido</option></select></div></div></div>`);
            if (unref(error)) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div style="${ssrRenderStyle({ fontFamily: `'Inter',system-ui,sans-serif` })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "display": "flex", "align-items": "flex-start", "justify-content": "space-between", "flex-wrap": "wrap", "gap": "12px", "margin-bottom": "20px" })}" data-v-7fc6a75e><div data-v-7fc6a75e><h1 style="${ssrRenderStyle({ "font-size": "22px", "font-weight": "800", "color": "#F1F5F9", "margin": "0" })}" data-v-7fc6a75e>Facturación CFDI 4.0</h1><p style="${ssrRenderStyle({ "font-size": "13px", "color": "rgba(100,116,139,0.85)", "margin-top": "4px" })}" data-v-7fc6a75e>`);
      if (unref(tab) === "orders") {
        _push(`<!--[-->`);
        if (unref(loadingOrders)) {
          _push(`<span data-v-7fc6a75e>Cargando pedidos…</span>`);
        } else {
          _push(`<span data-v-7fc6a75e>${ssrInterpolate(unref(orders).length)} pedido${ssrInterpolate(unref(orders).length !== 1 ? "s" : "")} · ${ssrInterpolate(unref(listos))} listo${ssrInterpolate(unref(listos) !== 1 ? "s" : "")} para facturar</span>`);
        }
        _push(`<!--]-->`);
      } else {
        _push(`<!--[-->`);
        if (unref(loadingCfdis)) {
          _push(`<span data-v-7fc6a75e>Cargando facturas…</span>`);
        } else if (unref(cfdiError)) {
          _push(`<span style="${ssrRenderStyle({ "color": "#fb7185" })}" data-v-7fc6a75e>${ssrInterpolate(unref(cfdiError))}</span>`);
        } else {
          _push(`<span data-v-7fc6a75e>Serie S · ${ssrInterpolate(unref(cfdis).length)} CFDI${ssrInterpolate(unref(cfdis).length !== 1 ? "s" : "")} emitido${ssrInterpolate(unref(cfdis).length !== 1 ? "s" : "")} `);
          if (unref(totalFacturado) > 0) {
            _push(`<!--[--> · <span style="${ssrRenderStyle({ "color": "#a5b4fc" })}" data-v-7fc6a75e>${ssrInterpolate(fmtMXN(unref(totalFacturado)))}</span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span>`);
      ...
      if (unref(tab) === "orders" && !unref(loadingOrders)) {
        ...
        if (unref(pendingForGlobal).length) {
          _push(`<span style="${ssrRenderStyle({ "padding": "1px 7px", "border-radius": "20px", "background": "rgba(245,158,11,0.2)", "font-size": "10px", "font-weight": "700" })}" data-v-7fc6a75e>${ssrInterpolate(unref(pendingForGlobal).length)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
      ...
      _push(`</div><div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "margin-bottom": "20px", "border-radius": "12px", "background": "rgba(255,255,255,0.03)", "border": "1px solid rgba(255,255,255,0.07)", "padding": "4px", "width": "fit-content" })}" data-v-7fc6a75e><!--[-->`);
      ssrRenderList(tabs, (t) => {
        ...
        })}" data-v-7fc6a75e>${ssrInterpolate(t.label)}</button>`);
      });
      _push(`<!--]--></div>`);
      if (unref(tab) === "orders") {
        _push(`<!--[--><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "repeat(4,1fr)", "gap": "12px", "margin-bottom": "20px" })}" data-v-7fc6a75e><!--[-->`);
        ssrRenderList(unref(orderKpis), (k) => {
          _push(`<div style="${ssrRenderStyle({ "border-radius": "14px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "padding": "16px 18px" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ fontSize: "24px", fontWeight: 800, background: k.grad, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", lineHeight: 1 })}" data-v-7fc6a75e>${ssrInterpolate(unref(loadingOrders) ? "—" : k.value)}</div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.8)", "margin-top": "4px", "font-weight": "500" })}" data-v-7fc6a75e>${ssrInterpolate(k.label)}</div></div>`);
        });
        _push(`<!--]--></div><div style="${ssrRenderStyle({ "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "padding": "14px 16px", "margin-bottom": "20px", "display": "flex", "flex-direction": "column", "gap": "10px" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "position": "relative", "max-width": "360px" })}" data-v-7fc6a75e>`);
        ...
        ssrRenderList(orderFilters, (f) => {
          ...
          })}" data-v-7fc6a75e>${ssrInterpolate(f.label)}</button>`);
        });
        _push(`<!--]--></div></div>`);
        if (unref(loadingOrders)) {
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "3px" })}" data-v-7fc6a75e><!--[-->`);
          ssrRenderList(5, (i) => {
            _push(`<div class="pulse" style="${ssrRenderStyle({ "border-radius": "12px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "height": "72px" })}" data-v-7fc6a75e></div>`);
          });
          _push(`<!--]--></div>`);
        } else if (unref(filteredOrders).length > 0) {
          _push(`<div style="${ssrRenderStyle({ "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "overflow": "hidden" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "0.8fr 1.6fr 0.7fr 0.8fr 0.9fr 120px", "gap": "0", "padding": "10px 18px", "border-bottom": "1px solid rgba(255,255,255,0.07)" })}" data-v-7fc6a75e><!--[-->`);
          ssrRenderList(["Pedido", "Cliente", "Artículos", "Total", "Estado fiscal", "Acción"], (h) => {
            _push(`<span style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,116,139,0.6)", "text-transform": "uppercase", "letter-spacing": "0.8px" })}" data-v-7fc6a75e>${ssrInterpolate(h)}</span>`);
          });
          _push(`<!--]--></div><!--[-->`);
          ssrRenderList(unref(filteredOrders), (o, idx) => {
            _push(`<div style="${ssrRenderStyle({ display: "grid", gridTemplateColumns: "0.8fr 1.6fr 0.7fr 0.8fr 0.9fr 120px", gap: 0, padding: "12px 18px", borderBottom: idx < unref(filteredOrders).length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none", alignItems: "center" })}" data-v-7fc6a75e><div data-v-7fc6a75e><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#E2E8F0", "font-family": "monospace" })}" data-v-7fc6a75e>${ssrInterpolate(o.id.slice(-6).toUpperCase())}</div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "rgba(100,116,139,0.5)", "margin-top": "2px" })}" data-v-7fc6a75e>${ssrInterpolate(fmtDate(o.createdAt))}</div></div><div style="${ssrRenderStyle({ "min-width": "0" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#E2E8F0", "white-space": "nowrap", "overflow": "hidden", "text-overflow": "ellipsis" })}" data-v-7fc6a75e>${ssrInterpolate(o.userName)}</div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "#38bdf8", "font-family": "monospace", "margin-top": "2px" })}" data-v-7fc6a75e>${ssrInterpolate(o.userFiscalRfc ?? "Sin RFC")}</div></div><div data-v-7fc6a75e><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#E2E8F0" })}" data-v-7fc6a75e>${ssrInterpolate(o.items.length)} art.</div></div><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "700", "color": "#a5b4fc" })}" data-v-7fc6a75e>${ssrInterpolate(fmtMXN(o.total))}</div><div data-v-7fc6a75e><span style="${ssrRenderStyle(billBadgeStyle(o))}" data-v-7fc6a75e>${ssrInterpolate(billBadgeLabel(o))}</span></div><div data-v-7fc6a75e>`);
            if (o.cfdiUid) {
              _push(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "5px", "font-size": "10px", "font-weight": "600", "color": "#818cf8" })}" data-v-7fc6a75e><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><path d="M20 6 9 17l-5-5" data-v-7fc6a75e></path></svg> CFDI emitido </div>`);
            } else if (canBill(o)) {
              _push(`<button style="${ssrRenderStyle({ "height": "32px", "padding": "0 14px", "border-radius": "8px", "background": "linear-gradient(135deg,#6366f1,#4f46e5)", "border": "none", "color": "#fff", "font-size": "11px", "font-weight": "700", "cursor": "pointer", "font-family": "inherit", "display": "flex", "align-items": "center", "gap": "5px", "white-space": "nowrap", "box-shadow": "0 2px 8px rgba(99,102,241,0.3)" })}" data-v-7fc6a75e><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><rect width="14" height="17" x="5" y="2" rx="2" data-v-7fc6a75e></rect><path d="M9 7h6M9 11h6M9 15h4" data-v-7fc6a75e></path></svg> Facturar </button>`);
            } else if (o.userFiscalCompleted && !o.userFacturaUid) {
              _push(`<button${ssrIncludeBooleanAttr(unref(syncing) === o.userId) ? " disabled" : ""} style="${ssrRenderStyle({ height: "32px", padding: "0 12px", borderRadius: "8px", background: "rgba(99,102,241,0.1)", border: "1px solid rgba(99,102,241,0.25)", color: "#818cf8", fontSize: "11px", fontWeight: 600, cursor: unref(syncing) === o.userId ? "not-allowed" : "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", gap: "5px", opacity: unref(syncing) === o.userId ? 0.6 : 1 })}" data-v-7fc6a75e>`);
              if (unref(syncing) === o.userId) {
                _push(`<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="spin" data-v-7fc6a75e><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" data-v-7fc6a75e></path></svg>`);
              } else {
                _push(`<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><path d="M21 2v6h-6" data-v-7fc6a75e></path><path d="M3 12a9 9 0 0 1 15-6.7L21 8" data-v-7fc6a75e></path><path d="M3 22v-6h6" data-v-7fc6a75e></path><path d="M21 12a9 9 0 0 1-15 6.7L3 16" data-v-7fc6a75e></path></svg>`);
              }
              _push(` ${ssrInterpolate(unref(syncing) === o.userId ? "Sincronizando…" : "Sincronizar")}</button>`);
            } else {
              _push(`<div style="${ssrRenderStyle({ "font-size": "10px", "color": "rgba(100,116,139,0.35)", "line-height": "1.3" })}" data-v-7fc6a75e>${ssrInterpolate(billBlockReason(o))}</div>`);
            }
            _push(`</div></div>`);
          });
          _push(`<!--]--></div>`);
        } else if (!unref(loadingOrders)) {
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "center", "padding": "50px", "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "font-size": "13px", "color": "#94a3b8" })}" data-v-7fc6a75e> No se encontraron pedidos </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      } else {
        _push(`<!--[--><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "repeat(3,1fr)", "gap": "12px", "margin-bottom": "20px" })}" data-v-7fc6a75e><!--[-->`);
        ssrRenderList(unref(cfdiKpis), (k) => {
          _push(`<div style="${ssrRenderStyle({ "border-radius": "14px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "padding": "16px 18px" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ fontSize: "24px", fontWeight: 800, background: k.grad, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", lineHeight: 1 })}" data-v-7fc6a75e>${ssrInterpolate(unref(loadingCfdis) ? "—" : k.value)}</div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.8)", "margin-top": "4px", "font-weight": "500" })}" data-v-7fc6a75e>${ssrInterpolate(k.label)}</div></div>`);
        });
        _push(`<!--]--></div><div style="${ssrRenderStyle({ "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "padding": "14px 16px", "margin-bottom": "20px" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "position": "relative", "max-width": "360px" })}" data-v-7fc6a75e>`);
        _push(ssrRenderComponent(unref(Search), {
          size: 13,
          style: { "position": "absolute", "left": "12px", "top": "50%", "transform": "translateY(-50%)", "pointer-events": "none" },
          color: unref(cfdiSearchFocus) ? "#6366f1" : "rgba(100,116,139,0.6)"
        }, null, _parent));
        _push(`<input${ssrRenderAttr("value", unref(cfdiSearch))} placeholder="Buscar por folio, RFC o nombre…" style="${ssrRenderStyle({ width: "100%", height: "38px", background: unref(cfdiSearchFocus) ? "rgba(99,102,241,0.06)" : "rgba(255,255,255,0.04)", border: `1px solid ${unref(cfdiSearchFocus) ? "rgba(99,102,241,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: "9px", paddingLeft: "36px", paddingRight: "12px", fontSize: "12px", color: "#E2E8F0", outline: "none", fontFamily: "inherit", boxSizing: "border-box", transition: "all 0.2s" })}" data-v-7fc6a75e></div></div>`);
        if (unref(loadingCfdis)) {
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "3px" })}" data-v-7fc6a75e><!--[-->`);
          ssrRenderList(5, (i) => {
            _push(`<div class="pulse" style="${ssrRenderStyle({ "border-radius": "12px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "height": "64px" })}" data-v-7fc6a75e></div>`);
          });
          _push(`<!--]--></div>`);
        } else if (unref(filteredCfdis).length > 0) {
          _push(`<div style="${ssrRenderStyle({ "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "overflow": "hidden" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "0.8fr 2fr 1fr 1fr 0.9fr 90px", "gap": "0", "padding": "10px 18px", "border-bottom": "1px solid rgba(255,255,255,0.07)" })}" data-v-7fc6a75e><!--[-->`);
          ssrRenderList(["Folio", "Cliente", "Fecha", "Total", "Estado", ""], (h) => {
            _push(`<span style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,116,139,0.6)", "text-transform": "uppercase", "letter-spacing": "0.8px" })}" data-v-7fc6a75e>${ssrInterpolate(h)}</span>`);
          });
          _push(`<!--]--></div><!--[-->`);
          ssrRenderList(unref(filteredCfdis), (c, idx) => {
            _push(`<div style="${ssrRenderStyle({ display: "grid", gridTemplateColumns: "0.8fr 2fr 1fr 1fr 0.9fr 90px", gap: 0, padding: "11px 18px", borderBottom: idx < unref(filteredCfdis).length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none", alignItems: "center" })}" data-v-7fc6a75e><div data-v-7fc6a75e><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "700", "color": "#E2E8F0", "font-family": "monospace" })}" data-v-7fc6a75e>${ssrInterpolate(c.Folio ?? "—")}</div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "rgba(100,116,139,0.45)", "margin-top": "2px", "font-family": "monospace", "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}"${ssrRenderAttr("title", c.UUID)} data-v-7fc6a75e>${ssrInterpolate(c.UUID.slice(0, 18))}…</div></div><div style="${ssrRenderStyle({ "min-width": "0" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "#E2E8F0", "white-space": "nowrap", "overflow": "hidden", "text-overflow": "ellipsis" })}" data-v-7fc6a75e>${ssrInterpolate(c.RazonSocialReceptor ?? "—")}</div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "#38bdf8", "font-family": "monospace", "margin-top": "2px" })}" data-v-7fc6a75e>${ssrInterpolate(c.Receptor ?? "")}</div></div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(148,163,184,0.8)" })}" data-v-7fc6a75e>${ssrInterpolate(fmtDate(c.FechaTimbrado))}</div><div data-v-7fc6a75e><div style="${ssrRenderStyle({ "font-size": "13px", "font-weight": "700", "color": "#a5b4fc" })}" data-v-7fc6a75e>${ssrInterpolate(fmtMXN(Number(c.Total ?? 0)))}</div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "rgba(100,116,139,0.5)" })}" data-v-7fc6a75e>MXN</div></div><div data-v-7fc6a75e><span style="${ssrRenderStyle(cfdiStatusStyle(c.Status))}" data-v-7fc6a75e>${ssrInterpolate(cfdiStatusLabel(c.Status))}</span></div><div style="${ssrRenderStyle({ "display": "flex", "gap": "6px", "justify-content": "flex-end" })}" data-v-7fc6a75e><button${ssrIncludeBooleanAttr(unref(downloading) === c.UID + "-pdf") ? " disabled" : ""} title="PDF" style="${ssrRenderStyle({ width: "32px", height: "32px", borderRadius: "8px", background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.2)", color: "#f87171", cursor: unref(downloading) === c.UID + "-pdf" ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", opacity: unref(downloading) === c.UID + "-pdf" ? 0.5 : 1 })}" data-v-7fc6a75e>`);
            if (unref(downloading) === c.UID + "-pdf") {
              _push(`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="spin" data-v-7fc6a75e><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" data-v-7fc6a75e></path></svg>`);
            } else {
              _push(`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" data-v-7fc6a75e></path><polyline points="7 10 12 15 17 10" data-v-7fc6a75e></polyline><line x1="12" y1="15" x2="12" y2="3" data-v-7fc6a75e></line></svg>`);
            }
            _push(`</button><button${ssrIncludeBooleanAttr(unref(downloading) === c.UID + "-xml") ? " disabled" : ""} title="XML" style="${ssrRenderStyle({ width: "32px", height: "32px", borderRadius: "8px", background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)", color: "#34d399", cursor: unref(downloading) === c.UID + "-xml" ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", opacity: unref(downloading) === c.UID + "-xml" ? 0.5 : 1 })}" data-v-7fc6a75e>`);
            if (unref(downloading) === c.UID + "-xml") {
              _push(`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="spin" data-v-7fc6a75e><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" data-v-7fc6a75e></path></svg>`);
            } else {
              _push(`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><polyline points="16 18 22 12 16 6" data-v-7fc6a75e></polyline><polyline points="8 6 2 12 8 18" data-v-7fc6a75e></polyline></svg>`);
            }
            _push(`</button></div></div>`);
          });
          _push(`<!--]--></div>`);
        } else if (!unref(loadingCfdis) && !unref(cfdiError)) {
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "align-items": "center", "justify-content": "center", "padding": "60px 20px", "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "gap": "12px", "text-align": "center" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "width": "48px", "height": "48px", "border-radius": "14px", "background": "rgba(99,102,241,0.08)", "border": "1px solid rgba(99,102,241,0.15)", "display": "flex", "align-items": "center", "justify-content": "center" })}" data-v-7fc6a75e><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="rgba(99,102,241,0.6)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z" data-v-7fc6a75e></path><path d="M16 8H8" data-v-7fc6a75e></path><path d="M16 12H8" data-v-7fc6a75e></path><path d="M12 16H8" data-v-7fc6a75e></path></svg></div><div style="${ssrRenderStyle({ "font-size": "14px", "font-weight": "600", "color": "#94a3b8" })}" data-v-7fc6a75e>No hay CFDIs serie S emitidos</div><div style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.6)" })}" data-v-7fc6a75e>Ve a la pestaña &quot;Pedidos&quot; para facturar a un cliente</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (!unref(loadingCfdis) && unref(cfdiTotalPages) > 1) {
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "center", "gap": "10px", "margin-top": "12px" })}" data-v-7fc6a75e><button${ssrIncludeBooleanAttr(unref(cfdiPage) === 1) ? " disabled" : ""} style="${ssrRenderStyle([{ "height": "32px", "padding": "0 14px", "border-radius": "8px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#94a3b8", "font-size": "12px", "font-weight": "600", "cursor": "pointer", "font-family": "inherit" }, { opacity: unref(cfdiPage) === 1 ? 0.4 : 1, cursor: unref(cfdiPage) === 1 ? "not-allowed" : "pointer" }])}" data-v-7fc6a75e> ← Anterior </button><span style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.7)" })}" data-v-7fc6a75e>Página ${ssrInterpolate(unref(cfdiPage))} de ${ssrInterpolate(unref(cfdiTotalPages))}</span><button${ssrIncludeBooleanAttr(unref(cfdiPage) === unref(cfdiTotalPages)) ? " disabled" : ""} style="${ssrRenderStyle([{ "height": "32px", "padding": "0 14px", "border-radius": "8px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#94a3b8", "font-size": "12px", "font-weight": "600", "cursor": "pointer", "font-family": "inherit" }, { opacity: unref(cfdiPage) === unref(cfdiTotalPages) ? 0.4 : 1, cursor: unref(cfdiPage) === unref(cfdiTotalPages) ? "not-allowed" : "pointer" }])}" data-v-7fc6a75e> Siguiente → </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      ...
      if (unref(downloadError)) {
        _push(`<div style="${ssrRenderStyle({ "position": "fixed", "bottom": "24px", "right": "24px", "padding": "12px 18px", "border-radius": "10px", "background": "#1e0a0f", "border": "1px solid rgba(244,63,94,0.3)", "font-size": "12px", "color": "#fb7185", "z-index": "2000", "display": "flex", "align-items": "center", "gap": "10px", "box-shadow": "0 8px 30px rgba(0,0,0,0.5)" })}" data-v-7fc6a75e>${ssrInterpolate(unref(downloadError))} <button style="${ssrRenderStyle({ "background": "none", "border": "none", "color": "#fb7185", "cursor": "pointer", "padding": "0", "font-size": "16px", "line-height": "1" })}" data-v-7fc6a75e>×</button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const facturas = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7fc6a75e"]]);
export {
  facturas as default
};
//# sourceMappingURL=facturas-Dg4QOd0u.js.map
