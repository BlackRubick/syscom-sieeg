...
async function fetchProductos(opts) {
  ...
  params.set("por_pagina", String((_a = opts.porPagina) != null ? _a : 50));
...
function facturaStatusStyle(estatus) {
  ...
  if (s.includes("cancel")) return { color: "#EF4444", dot: "#f43f5e", bg: "rgba(239,68,68,0.12)", label: estatus != null ? estatus : "Cancelada" };
  ...
  if (s.includes("enviad") || s.includes("transit")) return { color: "#7DD3FC", dot: "#7DD3FC", bg: "rgba(6,182,212,0.12)", label: estatus != null ? estatus : "Enviada" };
  if (s.includes("aprob")) return { color: "#22C55E", dot: "#22C55E", bg: "rgba(34,197,94,0.12)", label: estatus != null ? estatus : "Aprobada" };
  return { color: "#7DD3FC", dot: "#7DD3FC", bg: "rgba(14,165,233,0.12)", label: estatus != null ? estatus : "En proceso" };
}

export { adaptProduct as a, facturaStatusStyle as b, fmtCompact as c, fmtDate as d, fetchProductos as f, parseTotal as p };
//# sourceMappingURL=useSyscom-D0TdJReD.mjs.map
