...
import { _ as _sfc_main$2 } from './FiscalDataModal-D-vEbvgR.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(pwOpen)) {
          _push2(`<div style="${ssrRenderStyle({ "position": "fixed", "inset": "0", "z-index": "1041", "display": "flex", "align-items": "center", "justify-content": "center", "padding": "16px" })}"><div style="${ssrRenderStyle({ "width": "100%", "max-width": "420px", "border-radius": "20px", "background": "linear-gradient(160deg,#0D1B35,#09122A)", "border": "1px solid rgba(255,255,255,0.1)", "box-shadow": "0 32px 80px rgba(0,0,0,0.7)", "overflow": "hidden" })}"><div style="${ssrRenderStyle({ "padding": "20px 22px", "border-bottom": "1px solid rgba(255,255,255,0.07)" })}"><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "800", "color": "#F1F5F9" })}">Cambiar contrase\xF1a</div></div><div style="${ssrRenderStyle({ "padding": "20px 22px", "display": "flex", "flex-direction": "column", "gap": "14px" })}">`);
          if (unref(pwError)) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "9px 12px", "border-radius": "8px", "background": "rgba(244,63,94,0.1)", "border": "1px solid rgba(244,63,94,0.2)", "font-size": "12px", "color": "#fb7185" })}">${ssrInterpolate(unref(pwError))}</div>`);
          } else {
            _push2(`<!---->`);
          }
          if (unref(pwSuccess)) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "9px 12px", "border-radius": "8px", "background": "rgba(16,185,129,0.1)", "border": "1px solid rgba(16,185,129,0.2)", "font-size": "12px", "color": "#34d399" })}">${ssrInterpolate(unref(pwSuccess))}</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "6px" })}"><label style="${ssrRenderStyle({ "font-size": "11px", "font-weight": "600", "color": "rgba(100,116,139,0.8)" })}">Contrase\xF1a actual</label><input${ssrRenderAttr("value", unref(pwCurrent))} type="password" placeholder="\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" style="${ssrRenderStyle({ "height": "38px", "border-radius": "9px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#E2E8F0", "font-size": "13px", "padding": "0 12px", "outline": "none", "font-family": "inherit" })}"></div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "6px" })}"><label style="${ssrRenderStyle({ "font-size": "11px", "font-weight": "600", "color": "rgba(100,116,139,0.8)" })}">Nueva contrase\xF1a</label><input${ssrRenderAttr("value", unref(pwNew))} type="password" placeholder="M\xEDnimo 8 caracteres" style="${ssrRenderStyle({ "height": "38px", "border-radius": "9px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#E2E8F0", "font-size": "13px", "padding": "0 12px", "outline": "none", "font-family": "inherit" })}"></div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "6px" })}"><label style="${ssrRenderStyle({ "font-size": "11px", "font-weight": "600", "color": "rgba(100,116,139,0.8)" })}">Confirmar nueva contrase\xF1a</label><input${ssrRenderAttr("value", unref(pwConfirm))} type="password" placeholder="Repetir contrase\xF1a" style="${ssrRenderStyle({ "height": "38px", "border-radius": "9px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#E2E8F0", "font-size": "13px", "padding": "0 12px", "outline": "none", "font-family": "inherit" })}"></div><div style="${ssrRenderStyle({ "display": "flex", "gap": "10px", "margin-top": "4px" })}"><button style="${ssrRenderStyle({ "flex": "1", "height": "38px", "border-radius": "9px", "border": "1px solid rgba(255,255,255,0.1)", "background": "transparent", "color": "#94a3b8", "font-size": "12px", "font-weight": "600", "cursor": "pointer", "font-family": "inherit" })}">Cancelar</button><button${ssrIncludeBooleanAttr(unref(pwLoading)) ? " disabled" : ""} style="${ssrRenderStyle([{ "flex": "2", "height": "38px", "border-radius": "9px", "border": "none", "background": "linear-gradient(135deg,#0EA5E9,#0284C7)", "color": "white", "font-size": "13px", "font-weight": "700", "cursor": "pointer", "font-family": "inherit", "display": "flex", "align-items": "center", "justify-content": "center", "gap": "7px" }, { opacity: unref(pwLoading) ? 0.6 : 1, cursor: unref(pwLoading) ? "not-allowed" : "pointer" }])}">${ssrInterpolate(unref(pwLoading) ? "Guardando\u2026" : "Cambiar contrase\xF1a")}</button></div></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
//# sourceMappingURL=perfil-CFnrnzh_.mjs.map
