...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const panelItems = [
      ...
      { name: "Seguridad", sub: "CCTV \xB7 Control", icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>', gradient: "linear-gradient(135deg,#f43f5e,#e11d48)", glow: "rgba(244,63,94,0.35)" }
    ];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div style="${ssrRenderStyle({ "position": "relative", "display": "flex", "justify-content": "center", "align-items": "center" })}" class="hero-visual"><div style="${ssrRenderStyle({ "position": "absolute", "width": "340px", "height": "340px", "border-radius": "50%", "background": "radial-gradient(circle,rgba(14,165,233,0.18) 0%,rgba(124,58,237,0.12) 50%,transparent 70%)", "filter": "blur(40px)", "pointer-events": "none" })}"></div><div class="floating-panel"><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "space-between", "padding": "16px 18px", "border-bottom": "1px solid rgba(255,255,255,0.07)" })}"><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px" })}"><div style="${ssrRenderStyle({ "width": "8px", "height": "8px", "border-radius": "50%", "background": "#34d399", "box-shadow": "0 0 6px #34d399" })}"></div><span style="${ssrRenderStyle({ "font-size": "12px", "font-weight": "600", "color": "rgba(148,163,184,0.85)" })}">Cat\xE1logo disponible</span></div><span style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.7)", "background": "rgba(255,255,255,0.05)", "padding": "3px 8px", "border-radius": "20px", "border": "1px solid rgba(255,255,255,0.08)" })}">+5,000 SKUs</span></div><div style="${ssrRenderStyle({ "padding": "16px", "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "10px" })}"><!--[-->`);
      ...
      _push(`<p style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(71,85,105,0.7)", "margin": "0" })}">\xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} SIEEG INTEGRADORES. Todos los derechos reservados.</p></div></div></footer></div>`);
    };
  }
});
...
//# sourceMappingURL=index-xYVvs2Kl.mjs.map
