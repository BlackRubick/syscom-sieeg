import { _ as _sfc_main$2 } from './FormField-CqV_UbYV.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(filtered), (user) => {
          ...
          if (user.discountPct && user.discountPct > 0) {
            _push(`<span style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "700", "padding": "3px 9px", "border-radius": "20px", "background": "rgba(16,185,129,0.12)", "color": "#34d399", "border": "1px solid rgba(16,185,129,0.25)" })}"> -${ssrInterpolate(user.discountPct)}% </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(modal)) {
          ...
          _push2(`<div style="${ssrRenderStyle({ "grid-column": "1/-1" })}"><div style="${ssrRenderStyle({ "font-size": "11px", "font-weight": "600", "color": "rgba(100,116,139,0.9)", "margin-bottom": "6px", "letter-spacing": "0.3px" })}">Descuento en cat\xE1logo (%)</div><div style="${ssrRenderStyle({ "position": "relative" })}"><input${ssrRenderAttr("value", unref(form).discountPct)} type="number" min="0" max="100" step="0.5" placeholder="0" style="${ssrRenderStyle({ "width": "100%", "height": "40px", "background": "rgba(255,255,255,0.04)", "border": "1px solid rgba(255,255,255,0.1)", "border-radius": "10px", "padding": "0 40px 0 14px", "font-size": "13px", "color": "#E2E8F0", "outline": "none", "font-family": "inherit", "box-sizing": "border-box", "transition": "border-color 0.2s" })}"><span style="${ssrRenderStyle({ "position": "absolute", "right": "13px", "top": "50%", "transform": "translateY(-50%)", "font-size": "13px", "color": "rgba(100,116,139,0.6)", "pointer-events": "none" })}">%</span></div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,116,139,0.5)", "margin-top": "5px" })}">0 = precio normal \xB7 10 = 10% de descuento sobre precios SYSCOM</div></div></div>`);
          if (unref(formError)) {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(confirmDeleteId)) {
          ...
          _push2(`</div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "700", "color": "#F1F5F9" })}">\xBFEliminar a ${ssrInterpolate((_a = unref(deleteTarget)) == null ? void 0 : _a.name.split(" ")[0])}?</div><div style="${ssrRenderStyle({ "font-size": "13px", "color": "rgba(100,116,139,0.85)", "line-height": "1.5" })}"> Se eliminar\xE1 <strong style="${ssrRenderStyle({ "color": "#CBD5E1" })}">${ssrInterpolate((_b = unref(deleteTarget)) == null ? void 0 : _b.name)}</strong> del sistema.<br>Esta acci\xF3n no se puede deshacer. </div>`);
          if (unref(isSelf)) {
...
//# sourceMappingURL=users-Ks2wHeue.mjs.map
