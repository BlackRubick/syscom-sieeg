    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(submitted)) {
        ...
        ssrRenderList(unref(cart).items, (item, idx) => {
          ...
          _push(`</div><div style="${ssrRenderStyle({ "min-width": "0" })}"><div style="${ssrRenderStyle({ "font-size": "13px", "font-weight": "600", "color": "#E2EAF4", "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}">${ssrInterpolate((_d = (_c = item.product) == null ? void 0 : _c.name) != null ? _d : "\u2014")}</div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "rgba(100,118,142,0.65)", "margin-top": "2px", "display": "flex", "gap": "6px" })}"><span>${ssrInterpolate((_f = (_e = item.product) == null ? void 0 : _e.supplier) != null ? _f : "")}</span>`);
          ...
          _push(`</button></div><div style="${ssrRenderStyle({ "text-align": "right", "font-size": "14px", "font-weight": "700", "color": "#E2EAF4" })}">${ssrInterpolate(((_i = item.product) == null ? void 0 : _i.price) > 0 ? fmt(item.product.price * item.quantity) : "\u2014")}</div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "center" })}"><button style="${ssrRenderStyle({ "width": "28px", "height": "28px", "border-radius": "7px", "background": "transparent", "border": "1px solid transparent", "display": "flex", "align-items": "center", "justify-content": "center", "cursor": "pointer", "color": "rgba(100,118,142,0.35)", "transition": "all 0.15s" })}">`);
        ...
        _push(` Agregar m\xE1s productos </a></div></div><div style="${ssrRenderStyle({ "display": "flex", "gap": "16px", "align-items": "flex-start", "flex-wrap": "wrap" })}"><div style="${ssrRenderStyle({ "flex": "1", "min-width": "280px", "border-radius": "16px", "background": "linear-gradient(160deg,#0C1A2E,#06101E)", "border": "1px solid rgba(255,255,255,0.07)", "padding": "20px", "display": "flex", "flex-direction": "column", "gap": "18px" })}"><div style="${ssrRenderStyle({ "font-size": "13px", "font-weight": "700", "color": "#E2EAF4" })}">Detalles de la orden</div><div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "600", "color": "rgba(100,118,142,0.6)", "text-transform": "uppercase", "letter-spacing": "0.8px", "margin-bottom": "10px" })}">Prioridad</div><div style="${ssrRenderStyle({ "display": "flex", "gap": "6px" })}"><!--[-->`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(showPayModal)) {
          ...
          if (unref(payTab) === "card") {
            ...
            _push2(`<span style="${ssrRenderStyle({ "font-size": "10px", "color": "rgba(100,118,142,0.4)" })}">Pago cifrado SSL \xB7 Procesado por</span><div style="${ssrRenderStyle({ "background": "white", "border-radius": "4px", "padding": "1px 6px", "display": "inline-flex", "align-items": "center" })}"><img${ssrRenderAttr("src", _imports_1)} alt="Openpay" style="${ssrRenderStyle({ "height": "11px", "object-fit": "contain" })}"></div></div></div>`);
          } else {
...
//# sourceMappingURL=cart-DloiQFMN.mjs.map
