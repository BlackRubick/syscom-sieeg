  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(status) === "loading") {
        ...
        _push(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "align-items": "center", "text-align": "center", "gap": "4px" })}"><div style="${ssrRenderStyle({ "width": "80px", "height": "80px", "border-radius": "50%", "background": "linear-gradient(135deg,#22C55E,#34D399)", "display": "flex", "align-items": "center", "justify-content": "center", "margin-bottom": "16px", "box-shadow": "0 0 40px rgba(34,197,94,0.3)" })}"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"></path></svg></div><div style="${ssrRenderStyle({ "font-size": "22px", "font-weight": "800", "color": "#E2EAF4", "margin-bottom": "8px" })}">\xA1Transacci\xF3n exitosa!</div><div style="${ssrRenderStyle({ "font-size": "14px", "color": "#22C55E", "font-weight": "600", "margin-bottom": "6px" })}">Recibimos tu pago. \xA1Gracias por tu compra!</div><div style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,118,142,0.75)", "max-width": "300px", "line-height": "1.6", "margin-bottom": "6px" })}">El administrador procesar\xE1 tu pedido a la brevedad.</div>`);
        if (unref(authorization)) {
          _push(`<div style="${ssrRenderStyle({ "font-size": "11px", "font-family": "monospace", "color": "rgba(100,118,142,0.45)", "margin-bottom": "22px" })}">Autorizaci\xF3n: ${ssrInterpolate(unref(authorization))}</div>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=return-adEkIlTt.mjs.map
