    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(tab) === "orders") {
        ...
        if (unref(loadingCfdis)) {
          ...
          _push(`<span data-v-7fc6a75e>Serie S \xB7 ${ssrInterpolate(unref(cfdis).length)} CFDI${ssrInterpolate(unref(cfdis).length !== 1 ? "s" : "")} emitido${ssrInterpolate(unref(cfdis).length !== 1 ? "s" : "")} `);
          if (unref(totalFacturado) > 0) {
            _push(`<!--[--> \xB7 <span style="${ssrRenderStyle({ "color": "#a5b4fc" })}" data-v-7fc6a75e>${ssrInterpolate(fmtMXN(unref(totalFacturado)))}</span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span>`);
      ...
      if (unref(tab) === "orders") {
        ...
        if (unref(loadingCfdis)) {
          ...
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "align-items": "center", "justify-content": "center", "padding": "60px 20px", "border-radius": "16px", "background": "linear-gradient(160deg,#0D1B35,#091228)", "border": "1px solid rgba(255,255,255,0.07)", "gap": "12px", "text-align": "center" })}" data-v-7fc6a75e><div style="${ssrRenderStyle({ "width": "48px", "height": "48px", "border-radius": "14px", "background": "rgba(99,102,241,0.08)", "border": "1px solid rgba(99,102,241,0.15)", "display": "flex", "align-items": "center", "justify-content": "center" })}" data-v-7fc6a75e><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="rgba(99,102,241,0.6)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-7fc6a75e><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z" data-v-7fc6a75e></path><path d="M16 8H8" data-v-7fc6a75e></path><path d="M16 12H8" data-v-7fc6a75e></path><path d="M12 16H8" data-v-7fc6a75e></path></svg></div><div style="${ssrRenderStyle({ "font-size": "14px", "font-weight": "600", "color": "#94a3b8" })}" data-v-7fc6a75e>No hay CFDIs serie S emitidos</div><div style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.6)" })}" data-v-7fc6a75e>Ve a la pesta\xF1a &quot;Pedidos&quot; para facturar a un cliente</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (!unref(loadingCfdis) && unref(cfdiTotalPages) > 1) {
          _push(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "center", "gap": "10px", "margin-top": "12px" })}" data-v-7fc6a75e><button${ssrIncludeBooleanAttr(unref(cfdiPage) === 1) ? " disabled" : ""} style="${ssrRenderStyle([{ "height": "32px", "padding": "0 14px", "border-radius": "8px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#94a3b8", "font-size": "12px", "font-weight": "600", "cursor": "pointer", "font-family": "inherit" }, { opacity: unref(cfdiPage) === 1 ? 0.4 : 1, cursor: unref(cfdiPage) === 1 ? "not-allowed" : "pointer" }])}" data-v-7fc6a75e> \u2190 Anterior </button><span style="${ssrRenderStyle({ "font-size": "12px", "color": "rgba(100,116,139,0.7)" })}" data-v-7fc6a75e>P\xE1gina ${ssrInterpolate(unref(cfdiPage))} de ${ssrInterpolate(unref(cfdiTotalPages))}</span><button${ssrIncludeBooleanAttr(unref(cfdiPage) === unref(cfdiTotalPages)) ? " disabled" : ""} style="${ssrRenderStyle([{ "height": "32px", "padding": "0 14px", "border-radius": "8px", "border": "1px solid rgba(255,255,255,0.1)", "background": "rgba(255,255,255,0.04)", "color": "#94a3b8", "font-size": "12px", "font-weight": "600", "cursor": "pointer", "font-family": "inherit" }, { opacity: unref(cfdiPage) === unref(cfdiTotalPages) ? 0.4 : 1, cursor: unref(cfdiPage) === unref(cfdiTotalPages) ? "not-allowed" : "pointer" }])}" data-v-7fc6a75e> Siguiente \u2192 </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
...
//# sourceMappingURL=facturas-Dg4QOd0u.mjs.map
