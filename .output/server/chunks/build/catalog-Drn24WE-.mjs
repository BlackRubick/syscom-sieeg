...
import { f as fetchProductos, a as adaptProduct } from './useSyscom-BdSrtAOh.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(search)) {
        _push(`<button class="search-clear" data-v-ab4baa58>\xD7</button>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<span style="${ssrRenderStyle({ "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap", "max-width": "85px" })}" data-v-ab4baa58>${ssrInterpolate(unref(activeBrandId) ? (_b = (_a = unref(brands).find((b) => b.id === unref(activeBrandId))) == null ? void 0 : _a.nombre) != null ? _b : unref(activeBrandId) : "Marca")}</span></div>`);
      if (unref(activeBrandId)) {
        _push(`<span class="filter-btn-x" data-v-ab4baa58>\xD7</span>`);
      } else {
        _push(ssrRenderComponent(unref(ChevronDown), {
          size: 12,
          color: "rgba(100,116,139,0.65)"
      ...
      _push(`<span style="${ssrRenderStyle({ "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap", "max-width": "110px" })}" data-v-ab4baa58>${ssrInterpolate(unref(activeCategoryId) ? (_d = (_c = unref(categories).find((c) => c.id === unref(activeCategoryId))) == null ? void 0 : _c.nombre) != null ? _d : "Categor\xEDa" : "Categor\xEDas")}</span></div>`);
      ...
      if (unref(dSearch)) {
        ...
        _push(`<span style="${ssrRenderStyle({ "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}" data-v-ab4baa58>&quot;${ssrInterpolate(unref(dSearch).length > 18 ? unref(dSearch).slice(0, 18) + "\u2026" : unref(dSearch))}&quot;</span><button class="chip-x" data-v-ab4baa58>\xD7</button></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (unref(loadingCats)) {
        ...
        _push(`</div><div class="state-title" data-v-ab4baa58>Cargando cat\xE1logo\u2026</div><div class="state-sub" data-v-ab4baa58>Conectando con el cat\xE1logo SIEEG</div></div>`);
        ...
        _push(`</div><div class="state-title" data-v-ab4baa58>Busca o elige una categor\xEDa</div><div class="state-sub" data-v-ab4baa58>Escribe en el buscador o selecciona una categor\xEDa para ver los productos disponibles.</div></div>`);
        ...
        _push(`</div><div class="state-title" data-v-ab4baa58>Sin resultados</div><div class="state-sub" style="${ssrRenderStyle({ "margin-bottom": "20px" })}" data-v-ab4baa58>Prueba con otra b\xFAsqueda o categor\xEDa</div><button class="btn-clear" data-v-ab4baa58>Limpiar filtros</button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=catalog-Drn24WE-.mjs.map
