...
import { p as parseTotal, b as facturaStatusStyle, c as fmtCompact, d as fmtDate } from './useSyscom-D0TdJReD.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const kpis = computed(() => [
      { label: `Facturas ${YEAR}`, value: loading.value ? "\u2014" : totalOrders.value.toLocaleString("es-MX"), sub: "vs. a\xF1o anterior", delta: ordersDelta.value, icon: ShoppingBag, accent: "#0EA5E9", gradient: "linear-gradient(135deg,#0EA5E9,#7DD3FC)", glow: "rgba(14,165,233,0.2)" },
      { label: `Gasto total ${YEAR}`, value: loading.value ? "\u2014" : fmtCompact(totalSpent.value), sub: "vs. a\xF1o anterior", delta: spentDelta.value, icon: DollarSign, accent: "#8B5CF6", gradient: "linear-gradient(135deg,#0EA5E9,#7DD3FC)", glow: "rgba(139,92,246,0.2)" },
...
//# sourceMappingURL=dashboard-ClPBfnZo.mjs.map
